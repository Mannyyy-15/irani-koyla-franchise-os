...
export const INITIAL_OUTLETS: Outlet[] = [
  ...
  },
  {
    ...
    address: "Shop 4, Greenfield Heights, Linking Road, Bandra West, Mumbai 400050",
    status: "active",
    dailyTargetSales: 85000,
    dailyTargetWraps: 520,
    currentDaySales: 82400,
    currentDayWraps: 495,
    spitEfficiency: 95.8,
    activeSpits: 2,
    totalSpits: 2,
    ownerName: "Tariq Mansoori",
    ownerEmail: "partner.bandra@iranikoyla.com",
    ownerPhone: "+91 98204 11892",
    managerName: "Imran Sayed",
    managerPhone: "+91 98190 44321",
    fssaiNumber: "11523004000219",
    fssaiExpiry: "2027-08-15",
    lastAuditScore: 98,
    gstin: "27AABCT9182A1Z4",
    openedAt: "2023-11-10",
    loginEmail: "partner.bandra@iranikoyla.com",
    loginPassword: "password123",
    magicLoginToken: "tok_bandra_778129",
    franchiseFeeAmount: 1500000,
    franchiseFeeStatus: "paid",
    securityDepositAmount: 500000,
    royaltyRatePercent: 6.5,
    ...
    territoryRadiusKm: 3.0,
    agreementTermYears: 5,
    whatsappNumber: "+919820411892",
    panOrAadhaar: "AAATM9921M / 4192 8812 3341",
  },
  {
    id: "andheri-east",
    ...
    code: "IK-AND-02",
    city: "Mumbai",
    area: "JB Nagar, Andheri East",
    address: "Unit 12, Metro Junction Arcade, JB Nagar, Andheri East, Mumbai 400059",
    status: "active",
    ...
    ownerEmail: "partner.andheri@iranikoyla.com",
    ownerPhone: "+91 97022 55819",
    managerName: "Adil Khan",
    managerPhone: "+91 96191 77234",
    fssaiNumber: "11524009000881",
    fssaiExpiry: "2028-02-28",
    lastAuditScore: 95,
    gstin: "27AABCS3319K1Z8",
    openedAt: "2024-06-01",
    loginEmail: "partner.andheri@iranikoyla.com",
    loginPassword: "password123",
    magicLoginToken: "tok_andheri_441209",
    franchiseFeeAmount: 1500000,
    franchiseFeeStatus: "paid",
    securityDepositAmount: 500000,
    royaltyRatePercent: 6.5,
    ...
    territoryRadiusKm: 3.0,
    agreementTermYears: 5,
    whatsappNumber: "+919702255819",
    panOrAadhaar: "AAAPS7712Q / 7712 9901 2281",
  },
];
...
export const INITIAL_MEAT_BATCHES: MeatBatch[] = [
  ...
  },
  {
    ...
    outletName: "Mohak City Branch",
    meatType: "Koyla Marinated Chicken",
    spitId: "Spit-02 (Evening)",
    date: "2026-08-21",
    timeLoaded: "05:00 PM",
    rawMeatReceivedKg: 28.0,
    marinationLossKg: 1.0,
    skewerWeightKg: 27.0,
    cookedWeightKg: 25.5,
    wrapsProduced: 210,
    jumboWrapsProduced: 55,
    plattersProduced: 18,
    wasteScrapsKg: 0.7,
    targetYieldKg: 24.5,
    actualYieldPercent: 94.4,
    coreTempCelsius: 79.0,
    status: "roasting",
    loggedBy: "Master Carver Farhan",
    notes: "Evening rush replenishment cone.",
  },
  {
    id: "batch-201",
    batchNumber: "IK-MUM-260821-A",
    outletId: "bandra-west",
    outletName: "Bandra West Flagship",
    meatType: "Koyla Marinated Chicken",
    spitId: "Spit-01 (Flagship Front)",
    date: "2026-08-21",
    timeLoaded: "11:00 AM",
    rawMeatReceivedKg: 42.0,
    marinationLossKg: 1.4,
    skewerWeightKg: 40.6,
    cookedWeightKg: 38.9,
    wrapsProduced: 310,
    jumboWrapsProduced: 85,
    plattersProduced: 30,
    wasteScrapsKg: 1.1,
    targetYieldKg: 37.0,
    actualYieldPercent: 95.8,
    coreTempCelsius: 79.5,
    status: "roasting",
    loggedBy: "Master Carver Imran",
    notes: "High volume Friday peak batch.",
  },
  {
    id: "batch-301",
    batchNumber: "IK-AND-260821-A",
    outletId: "andheri-east",
    outletName: "Andheri East Express",
    meatType: "Koyla Marinated Chicken",
    spitId: "Spit-01 (Express Spit)",
    date: "2026-08-21",
    timeLoaded: "11:45 AM",
    rawMeatReceivedKg: 28.0,
    ...
    wasteScrapsKg: 0.8,
    targetYieldKg: 24.5,
    actualYieldPercent: 93.6,
    coreTempCelsius: 78.0,
    status: "roasting",
    loggedBy: "Master Carver Adil",
    notes: "Express counter lunchtime roast.",
  },
];
...
export const INITIAL_SHIFTS: ShiftRegister[] = [
  ...
  },
  {
    ...
    date: "2026-08-21",
    shiftType: "Morning Shift (11:00 AM - 05:00 PM)",
    cashierName: "Imran Sayed",
    openingCash: 6000,
    cashSalesExpected: 22400,
    cashInDrawerActual: 22400,
    cashDifference: 0,
    upiSales: 34800,
    swiggySales: 14200,
    zomatoSales: 11000,
    posCardSales: 4000,
    pettyCashExpenses: 950,
    totalOrders: 198,
    totalGrossSales: 82400,
    discountsGiven: 1800,
    netRevenue: 80600,
    status: "reconciled",
  ...
  },
  {
    ...
    date: "2026-08-21",
    shiftType: "Morning Shift (11:00 AM - 05:00 PM)",
    cashierName: "Adil Khan",
    openingCash: 4000,
    cashSalesExpected: 14200,
    cashInDrawerActual: 14200,
    cashDifference: 0,
    upiSales: 22800,
    swiggySales: 9600,
    zomatoSales: 7600,
...
export const INITIAL_ROYALTIES: RoyaltyStatement[] = [
  ...
  },
  {
    ...
    grossSales: 2480000,
    royaltyRatePercent: 6.5,
    royaltyAmount: 161200,
    marketingFeePercent: 2.0,
    marketingFeeAmount: 49600,
    centralKitchenSupplyCost: 360000,
    deductionsAndAdjustments: 0,
    gstAmount: 37944,
    totalPayable: 248744,
    dueDate: "2026-09-10",
  ...
  },
  {
    ...
    grossSales: 1620000,
    royaltyRatePercent: 6.5,
    royaltyAmount: 105300,
    marketingFeePercent: 2.0,
    marketingFeeAmount: 32400,
    centralKitchenSupplyCost: 240000,
    deductionsAndAdjustments: 0,
    gstAmount: 24786,
    totalPayable: 162486,
    dueDate: "2026-09-10",
