  ...
  return (
    <div className="space-y-6">
      ...
      {isSuperAdmin ? (
        ...
        <div className="space-y-6">
          {/* Daily Store Lifecycle & Shift Session Bar */}
          <div className="p-4 rounded-2xl bg-[#1a1a1c] border border-[#2e2e30] flex flex-col md:flex-row items-start md:items-center justify-between gap-4 shadow-sm">
              ...
              <div>
                <div className="flex items-center gap-2 flex-wrap">
                  <span className="text-sm font-black text-white">
                    {dailySession.status === "OPEN" ? "🟢 Store Open & Live Billing" : "🌙 Store Closed (EOD Completed)"}
                  </span>
            ...
            <div className="flex items-center gap-2 flex-wrap w-full md:w-auto">
              <button
                ...
                className="px-3.5 py-2 rounded-xl bg-orange-600/15 hover:bg-orange-600/25 border border-orange-500/40 text-orange-400 hover:text-orange-300 text-xs font-bold flex items-center gap-1.5 transition-colors cursor-pointer"
              >
                <Sun className="w-3.5 h-3.5" />
                <span>Open Store / New Float</span>
              </button>
              <button
                type="button"
                onClick={() => setIsClosingModalOpen(true)}
                className="px-3.5 py-2 rounded-xl bg-indigo-600/15 hover:bg-indigo-600/25 border border-indigo-500/40 text-indigo-400 hover:text-indigo-300 text-xs font-bold flex items-center gap-1.5 transition-colors cursor-pointer"
              >
                <Moon className="w-3.5 h-3.5" />
                <span>EOD Close (Z-Report)</span>
              </button>
              <button
                type="button"
                onClick={() => resetStoreToFreshMorning(activeOutlet?.id)}
                className="px-2.5 py-2 rounded-xl bg-[#242427] hover:bg-[#303035] border border-[#383838] text-zinc-400 hover:text-zinc-200 text-xs font-bold flex items-center gap-1 transition-colors cursor-pointer"
                title="Reset counters to start a fresh test day"
              >
